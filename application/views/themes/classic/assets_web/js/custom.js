...
//        autoplay: true,
    ...
    $(".main_slider").on("translate.owl.carousel", function () {
        ...
        $(this).find(".owl-item .animated_caption > h6").removeClass("fadeInUp animated").css("opacity","0");
    ...
    $(".main_slider").on("translated.owl.carousel", function () {
        ...
        $(this).find(".owl-item.active .animated_caption > h6").addClass("fadeInUp animated").css("opacity","1");
