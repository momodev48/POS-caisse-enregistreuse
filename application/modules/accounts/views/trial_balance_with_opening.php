            ...
            <div id="printArea">
                <div class="panel-body">
                    <table width="100%" class="table_boxnew trial_balance_with_opening_as_tp" >
                        ...
                        <tr class="table_head">
                            <td width="20%" align="center"  class="trial_balance_with_opening_mrt_tbl_t"><strong><?php echo display('code');?></strong></td>
                            <td width="50%" align="center" class="trial_balance_with_opening_mrt_tbl_t"><strong><?php echo display('account_name');?></strong></td>
                            <td width="15%" align="center" class="trial_balance_with_opening_mrt_tbl_t"><strong><?php echo display('debit');?></strong></td>
                        ...
                        ?>
                        <tr class="table_data">
                          <td  align="left" bgcolor="<?php echo $bg;?>" class="trial_balance_with_opening_all_b">&nbsp;</td>
                        ...
                        <tr class="table_head">
                          <td colspan="2" align="right"  class="trial_balance_with_opening_mrt_bl_bb_bt"><strong><?php echo display('total') ?></strong></td>
