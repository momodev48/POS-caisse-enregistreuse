    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                         ...
                         <?php echo  form_open_multipart('accounts/accounts/update_credit_voucher') ?>
                     <div class="form-group row">
                        <label for="vo_no" class="col-sm-2 col-form-label"><?php echo display('voucher_no') ?></label>
                        <div class="col-sm-4">
                             <input type="text" name="txtVNo" id="txtVNo" value="<?php echo $debit_info->VNo; ?>" class="form-control" readonly>
                        </div>
                    </div> 
                     <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                          <select name="cmbDebit" id="cmbDebit" class="form-control">
                            ...
                            <option value="<?php echo $cracc->HeadCode?>" <?php if($debit_info->COAID == $cracc->HeadCode){
                              echo 'selected';
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                             <input type="text" name="dtpDate" id="dtpDate" class="form-control datepicker" value="<?php echo $debit_info->VDate;?>">
                        </div>
                    </div> 
                    <div class="form-group row">
                        <label for="txtRemarks" class="col-sm-2 col-form-label"><?php echo display('remark') ?></label>
                        <div class="col-sm-4">
                          <textarea  name="txtRemarks" id="txtRemarks" class="form-control"><?php echo $debit_info->Narration;?></textarea>
                        </div>
                    </div> 
                             ...
                             <tfoot>
                                    <tr>
                                      <td >
                                        ...
                                        <td class="text-right">
                                            <input type="text" id="grandTotal" class="form-control text-right " name="grand_total" value="<?php echo $debit_info->Debit;?>" readonly="readonly" />
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
...
<script src="<?php echo base_url('application/modules/accounts/assets/js/update_credit_bdtvoucher_script.js'); ?>" type="text/javascript"></script>
