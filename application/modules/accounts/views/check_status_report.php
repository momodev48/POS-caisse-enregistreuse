                ...
                <div class="row" id="">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="checkbox" id="chkIsTransction" name="chkIsTransction" size="40"/>&nbsp;&nbsp;&nbsp;<label for="chkIsTransction"><?php echo display('withdetails') ?></label>
                            </div>
                        </div>
...
<script src="<?php echo base_url('application/modules/accounts/assets/js/check_status_report_script.js'); ?>" type="text/javascript"></script>