        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                    ...
                    <div class="form-group row">
                       ...
                       <div class="table-responsive update_dbt_crtvoucher_mr_tp">
                            <table class="table table-bordered table-hover" id="debtAccVoucher"> 
                                ...
                                <tbody id="debitvoucher">
                                   ...
                                   foreach ($dbvoucher_info as $debitvoucher){?>
                                    ...
                                    <tr>
                                        <td class="update_dbt_crtvoucher_w_200">  
   ...
   <option value="<?php echo $acc1->HeadCode;?>"  <?php if($debitvoucher->COAID ==$acc1->HeadCode){
    echo 'selected';
         ...
         <?php }?>
                                       ...
                                       <td>
                                                <button  class="btn btn-danger red update_dbt_crtvoucher_btn" type="button" value="<?php echo display('delete')?>" onclick="udebitdeleteRow(this)"><i class="fa fa-trash-o"></i></button>
                                            </td>
                                    </tr>   
                                    <?php $sl++;} ?>                           
...
<script src="<?php echo base_url('application/modules/accounts/assets/js/update_dbt_crtvoucher_script.js'); ?>" type="text/javascript"></script>