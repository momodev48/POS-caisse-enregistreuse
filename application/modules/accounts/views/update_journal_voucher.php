        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                    ...
                    <div class="form-group row">
                       ...
                       <div class="table-responsive update_journal_voucher_mr_top">
                            <table class="table table-bordered table-hover" id="debtAccVoucher"> 
                                ...
                                <tbody id="debitvoucher">
                                        ...
                                        foreach ($journal_info as $single) {
                                            ?>
                                            <tr>
                                                <td class="update_journal_voucher_w_200">  
                                                ...
                                                <td>
                                                    <button  class="btn btn-danger red update_journal_voucher_btn" type="button" value="Delete" onclick="ujournaldeleteRow(this)"><i class="fa fa-trash-o"></i></button>
                                                </td>
                                            </tr>                              
                                            <?php
                                            $sl++;
...
<script src="<?php echo base_url('application/modules/accounts/assets/js/update_journal_voucher_script.js'); ?>" type="text/javascript"></script>