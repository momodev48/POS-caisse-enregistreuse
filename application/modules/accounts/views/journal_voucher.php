<div class="row">
        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                    ...
                    <div class="form-group row">
                       ...
                       <div class="table-responsive  journal_voucher_mr_t">
                            <table class="table table-bordered table-hover" id="debtAccVoucher"> 
                                ...
                                <tbody id="debitvoucher">
                                    ...
                                    <tr>
                                        <td class="journal_voucher_w_200">  
   ...
   <option value="<?php echo $acc1->HeadCode;?>"><?php echo $acc1->HeadName;?></option>
         <?php }?>
                                       ...
                                       <td>
                                                <button  class="btn btn-danger red journal_voucher_btn_right" type="button" value="<?php echo display('delete')?>" onclick="journaldeleteRow(this)"><i class="fa fa-trash-o"></i></button>
                                            </td>
                                    </tr>                              
...
<script src="<?php echo base_url('application/modules/accounts/assets/js/journal_voucher_script.js'); ?>" type="text/javascript"></script>