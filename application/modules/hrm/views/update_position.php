<div class="row">
        <div class="col-sm-12 col-md-12">
            <div class="panel panel-bd lobidrag">
                ...
                <?php echo  form_open_multipart('hrm/employees/update_form/'. $data->pos_id) ?>
                    ...
                    <input name="pos_id" type="hidden" value="<?php echo $data->pos_id ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="position_details" class="form-control" id="position_details" value="<?php echo $data->position_details?>">
                            </div>
                        </div> 
