...
(function ($) {
    ...
    $.confirm = function (options, e) {
        ...
        if (settings.title !== '') {
            modalHeader =
                '<div class="modal-header printcssheader">' +
        ...
        var modalHTML =
                '<div class="confirmation-modal modal fade bd-example-modal-sm" tabindex="-1" role="dialog">' +
                    '<div class="'+ settings.dialogClass +' modal-sm">' +
                        '<div class="modal-content">' +
                            modalHeader +
                            '<div class="modal-body printcss">' + settings.text + '</div>' +
                            '<div class="modal-footer printcssfooter">' +
